<template>
  <div class="selection:bg-[#2EA4DF] selection:text-white">
    <svg
    ...
    <div class="flex w-max h-max gap-6 items-center flex-wrap mx-auto mt-6">
      <indicator />
      <h2 class="text-[#2EA4DF] text-wrap text-center font-semibold text-3xl">
        Server running for
        <a
          target="_blank"
          href="https://t.me/samithseu_bot"
...
<script setup>
import indicator from "./Icon/indicator.vue";
</script>
